object frmRightBaru: TfrmRightBaru
  Left = 0
  Top = 0
  ClientHeight = 91
  ClientWidth = 369
  Caption = 'Tambah Right'
  ...
  object cbRight: TUniComboBox
    ...
    Text = ''
    Items.Strings = (
      'ROLE_RESULT_PDF_VIEW'
      'ROLE_RESULT_PDF_EMAIL'
      'ROLE_VIEW_CONFIDENTIAL_RESULT'
      'ROLE_RUTINE'
      'ROLE_CITO')
    TabOrder = 0
    IconItems = <>
