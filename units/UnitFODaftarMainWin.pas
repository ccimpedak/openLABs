...
uses
  ...
  Data.DB,  FireDAC.Comp.DataSet, uniBasicGrid,
...
type
  TUniFODaftarMainWin = class(TUniFrame)
...
uses UnitCariPasien, UnitFODaftar, UnitFOStatus, UnitLaporanHarian;

procedure TUniFODaftarMainWin.UniButton1Click(Sender: TObject);
begin
  frmFODaftar.ShowModal;
end;

procedure TUniFODaftarMainWin.UniButton2Click(Sender: TObject);
begin
  frmFOStatus.ShowModal;
end;

procedure TUniFODaftarMainWin.UniButton3Click(Sender: TObject);
begin
...
RegisterClass(TUniFODaftarMainWin);
