object UniVHasilByMR: TUniVHasilByMR
  ...
  object DSOrderTests: TDataSource
    DataSet = QOrderTests
    Left = 48
    Top = 295
  end
  object QPasien: TFDQuery
    AfterScroll = QPasienAfterScroll
  ...
  object QOrder: TFDQuery
    AfterOpen = QOrderAfterScroll
    AfterScroll = QOrderAfterScroll
    AfterRefresh = QOrderAfterScroll
    Connection = UniMainModule.FDConnection1
    SQL.Strings = (
      ...
      'where'
      'order_header.pasien_id = :pasien_id'
  ...
  object QOrderTests: TFDQuery
    Connection = UniMainModule.FDConnection1
    SQL.Strings = (
      'select no_pendaftaran,kd_tindakan,nm_tindakan'
      'from'
      'worklist_tindakan'
      'where'
